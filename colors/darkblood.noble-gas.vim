...
let g:colors_name = "darkblood.noble-gas"
...
hi ErrorMsg      cterm=NONE      ctermfg=125       ctermbg=NONE
...
hi IncSearch     cterm=bold      ctermfg=232       ctermbg=125
hi Search        cterm=bold      ctermfg=232       ctermbg=125
hi Visual        cterm=NONE      ctermfg=white     ctermbg=125
hi VisualNOS     cterm=NONE      ctermfg=white     ctermbg=125
...
hi TabLineSel    cterm=underline ctermfg=white     ctermbg=125
...
hi DiffDelete    cterm=NONE      ctermfg=white     ctermbg=125
hi DiffText      cterm=NONE      ctermfg=white     ctermbg=NONE
hi SignColumn    cterm=NONE      ctermfg=125       ctermbg=NONE
hi VertSplit     cterm=NONE      ctermfg=125       ctermbg=NONE
...
hi Cursor        cterm=bold      ctermfg=white     ctermbg=125
hi Title         cterm=bold      ctermfg=white     ctermbg=NONE
hi Pmenu         cterm=NONE      ctermfg=NONE      ctermbg=233
hi PmenuSel      cterm=bold      ctermfg=white     ctermbg=125
hi PmenuSbar     cterm=NONE      ctermfg=233       ctermbg=233
hi PmenuThumb    cterm=NONE      ctermfg=125       ctermbg=125
hi Folded        cterm=NONE      ctermfg=125       ctermbg=NONE
hi FoldColumn    cterm=NONE      ctermfg=125       ctermbg=NONE
hi MatchParen    cterm=reverse   ctermfg=NONE      ctermbg=NONE

" Status line
hi StatusLine    cterm=NONE ctermfg=125 ctermbg=NONE
hi StatusLineNC  cterm=NONE ctermfg=125 ctermbg=black
...
hi SpellRare     cterm=bold      ctermfg=232       ctermbg=125
hi SpellLocal    cterm=NONE      ctermfg=125   ctermbg=NONE
hi SpellCap      cterm=underline ctermfg=251       ctermbg=NONE

" tty
if &term =~ "linux"
	hi TabLine       cterm=NONE ctermfg=white ctermbg=NONE
	hi TabLineSel    cterm=NONE ctermfg=white ctermbg=125
	hi TabLineFill   cterm=NONE ctermfg=white ctermbg=NONE
	hi StatusLine    cterm=NONE ctermfg=black ctermbg=125
	hi StatusLineNC  cterm=NONE ctermfg=white ctermbg=NONE
endif

" Taglist
hi TagListFileName cterm=NONE ctermfg=125 ctermbg=NONE
...
hi CtrlPStats cterm=NONE ctermfg=black ctermbg=125
...
" Coc
hi CocErrorSign   cterm=NONE      ctermfg=white ctermbg=125
...
hi Constant    cterm=NONE ctermfg=125  ctermbg=NONE
hi Type        cterm=NONE ctermfg=125      ctermbg=NONE
hi Statement   cterm=bold ctermfg=white    ctermbg=NONE
hi Specifier   cterm=bold ctermfg=125      ctermbg=NONE
...
hi Error       cterm=NONE ctermfg=white    ctermbg=125
hi Todo        cterm=NONE ctermfg=white    ctermbg=125
hi Underlined  cterm=NONE ctermfg=125  ctermbg=NONE
hi Number      cterm=NONE ctermfg=125  ctermbg=NONE
