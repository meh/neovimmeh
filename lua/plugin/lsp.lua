...
conform.setup({formatters_by_ft = {lua = {"stylua"}, python = {"black"}, rust = {"rustfmt", lsp_format = "fallback"}, qml = {"qmlformat"}, nix = {"nixfmt"}, javascript = {"prettierd", "prettier", lsp_format = "fallback", stop_at_first = true}}, display = {chat = {window = {width = 0.2}}}, log_level = vim.log.levels.DEBUG, format_on_save = {timeout_ms = 2000, lsp_format = "fallback"}})
